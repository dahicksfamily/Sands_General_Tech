...
public class ModDimensions {
    public static final ResourceKey<LevelStem> SPACE_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            ResourceLocation.fromNamespaceAndPath (SGT.MOD_ID, "spacedim"));
    ...
    public static final ResourceKey<DimensionType> SPACE_DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            ResourceLocation.fromNamespaceAndPath (SGT.MOD_ID, "spacedim_type"));
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        LevelStem stem = new LevelStem(dimTypes.getOrThrow(ModDimensions.SPACE_DIM_TYPE), VoidGenerator);
