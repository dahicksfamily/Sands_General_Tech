package net.dahicksfamily.sgt.common.registry;
...
public class ModDimensions {
    public static final ResourceKey<LevelStem> SPACEDIM_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            new ResourceLocation(SGT.MOD_ID, "spacedim"));
    public static final ResourceKey<Level> SPACEDIM_LEVEL_KEY = ResourceKey.create(Registries.DIMENSION,
            new ResourceLocation(SGT.MOD_ID, "spacedim"));
    public static final ResourceKey<DimensionType> SPACEDIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            new ResourceLocation(SGT.MOD_ID, "spacedim_type"));
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        LevelStem stem = new LevelStem(dimTypes.getOrThrow(SPACEDIM_TYPE), VoidGenerator);

        context.register(SPACEDIM_KEY, stem);
    }
}
